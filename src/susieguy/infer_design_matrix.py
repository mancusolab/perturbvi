...
def _update_z(
    ...
    update_mu_z = (params.tau * X @ E_W.T + G @ params.mu_beta) @ update_var_z
...
def _reorder_factors_by_pve(
    ...
    sorted_beta = params.mu_beta[:, sorted_indices]
    #sorted_susie_pip = params.susie_pip[:, sorted_indices]
